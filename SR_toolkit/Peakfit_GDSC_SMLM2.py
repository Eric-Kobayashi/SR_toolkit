...
#		json.dump(d, f, indent=2) 	# Report back the results to python
	...
	for img, mydir in List_of_mydir:
		...
		f = op.basename(img)
		try:
			w, h = GDSC_SMLM(r, f, mydir, trim_track, bg_measurement, spot_filter, pixel_size, camera_gain, camera_bias, frame_length, signal_strength, precision, min_photons, sr_scale)
